...
# v0r0  : 2014/01/15 : Branch from "V2.main.v8r0.tcl"
# v0r05 : 2014/01/21 : feedback from E1L24 PROP STA
# v0r06 : 2014/01/24 : Revise Bigskew,WriteSDF(forSim)
# v0r07 : 2014/01/31 : remove PAD delay
# v0r08 : 2014/02/03 : separate DFT AC constraints
# v0r09 : 2014/02/14 : maxtrancap, DeltaDelayRatio
# v0r09 : 2014/02/14 : maxtrancap, DeltaDelayRatio
# v0r10 : 2014/02/21 : File locations have changed
# v0r12 : 2014/03/20 : VDD/GND case was removed
# v0r13 : 2014/04/03 : PT_ECO_FILE added
# v1r00 : 2014/05/08 : SMVA supported
# v1r01 : 2014/05/08 : ENABLE_ANNOTATED_CHECK added
# v1r02 : 2014/06/19 : SIMSDF_ANNO_ZERO_FILE is modified
# v1r03 : 2014/07/13 : min_period added
# v1r04 : 2014/07/17 : HighFreq dont_use added
# v1r05 : 2014/07/26 : AOCVM CU report file name was same to OCV.
# v1r06 : 2014/11/23 : Feedback from FCC2 and applying for PrimeTime2013
# v1r07 : 2014/12/03 : clock_sense_compatibility.tbc was deleted.
# v1r08 : 2015/03/13 : PrimeTime2014.06-SP1 is supported for SMVA
# v1r09 : 2015/04/24 : Critical Pins jobs are updated
# v1r10 : 2015/05/26 : Variables are changed for SignOff
# v1r11 : 2015/07/10 : Lumped check is added
# v1r12 : 2015/09/08 : handle Block SPEF(as trial)
#                    : HighVoltage Tran/Cap
# v1r13 : 2015/09/22 : Get Detail report(Skewed,Delta)
# v1r14 : 2015/11/06 : add maxtran/cap for HV option(-period_value)
# v1r15 : 2015/11/25 : Remove set resistance after update_timing -full
# v1r16 : 2015/12/10 : modify AOCVM path_group bug
# v1r17 : 2016/01/21 : To get clock pin list
# v1r18 : 2016/05/12 : Feedback D1M-E(Change Order block spef/save_session)
# v1r19 : 2016/07/11 : Support PT201512, lowdrive@320MHz/HighFreqDontUse
# v1r20 : 2016/07/14 : Change AOCVM session name
# v1r21 : 2016/07/21 : support PT2014.12
# v1r22 : 2016/08/11 : AOCVM GBA margin up 0 -> 300ps
# v1r23 : 2016/08/31 : add "exit" for batch jobs
# v1r24 : 2016/09/14 : Transition separate
# v1r25 : 2016/12/28 : remove MPI constraints, add SDC_MASK constraints
# v1r26 : 2017/01/06 : ENABLE_GCLKPATH variable is added.
# v1r27 : 2017/02/02 : CANCEL_TENTATIVE variable is added.
# v1r28 : 2017/02/20 : Add COMP_VAR command to compare variables
# v1r29 : 2017/03/13 : Handle RV28F condition
# v1r30 : 2017/04/10 : support PT2015.12-sp3
# v1r31 : 2017/06/01 : add annotate report for Kobetsu
# v1r32 : 2017/07/26 : remove_option "read_parastics -complete_with zero"
#                    : Add variables IGNORE_TRAN_CLKS
# v1r33 : 2017/08/30 : Change VCC MaxCap relax constraints for RV28F
# v1r34 : 2017/10/08 : ADD REMOVE_DESIGN is supported
# v1r35 : 2017/10/13 : ADD ENABLE_REMOVE_DESIGN variable
# v1r36 : 2017/11/27 : Add Write Delta SDF
# v1r37 : 2018/01/18 : remove XtalkDelta Max report(not use)
# v1r38 : 2018/03/09 : support PT2016.12/significant digit 4->3
# v1r39 : 2018/04/12 : support advanced waveform propagation for RV28F
# v1r40 : 2018/04/30 : Change PT2015.12 support version
# v1r41 : 2018/05/11 : Change AWP tbc for PT2015.12-SP3-1
# v1r42 : 2018/06/05 : Change COMP_VAR Variables
# v1r43 : 2018/07/02 : ccst_wfp_awp.tbc setting is removed from RV28F library.
# v1r44 : 2018/08/09 : -include_hierarchical_pins option is added for PT2014.06-SP1 -
# v1r45 : 2019/01/29 : Add ForceSetting ptsc for annotate_transition/integrate CU
# v1r46 : 2019/02/05 : change Async Transition initial value 999->99999.999
# v1r47 : 2019/06/10 : change make_chkprime.csh -> make_chkprime.pl
# v1r48 : 2019/08/19 : apply 9001516371_WA.tbc to analyze max_tran/cap correctly
# v1r49 : 2020/03/08 : support PT201712
# v1r50 : 2020/04/03 : timing_crpr_threshold_ps change 1 -> 2 for TAT/MEM
# v1r51 : 2020/07/15 : Change SMVA process(batch: exit, debug: continue with SMVA analysis)
# v1r52 : 2020/09/03 : Add variable MAXFANOUT_THRESHOLD and tcl_precision(12)/(6:write_SDC)
# v1r53 : 2020/09/17 : Change SET_INIT_VAR MAXTRANCAP_FREQ_RELAX value from 0.092 to 0.000
# v1r54 : 2020/10/16 : support MF3 signoff
# v1r55 : 2020/11/11 : Add make clock latency hisgtram procedure.
# v1r56 : 2021/02/19 : Add pin name equivalent setting
# v1r57 : 2021/07/12 : change NUM_SLACK 0.1ps -> -0.01ps
#                    : Move parasitic_load_location variable setting to before read SPEF
# v1r58 : 2021/07/21 : Add save pin for HOLD
...
# v1r59 : 2021/08/16 : Add ENABLE_CU_CHECK
# v1r60 : 2021/11/29 : Optimize mkHF/ML netlist section
# v1r61 : 2021/12/13 : Add PT_VER202009
# v1r62 : 2022/01/12 : Delete mkSDF mode, Add message information of input netlist/spef
#                    : Set smva legacy mode for PT2020
# v1r63 : 2022/02/01 : Support PhysicalAware STA
# v1r64 : 2022/03/02 : Change procedure for no_clock
#
##############################################
...
set PT_VER202009 R-2020.09-SP5-2
...
#------------------------------------------------------------------
# *     STA_MODE              : INIT/mkHF/SYSTEM/DFT
#------------------------------------------------------------------
# *     DFT_MODE              : SCAN/MBIST/FBIST
#------------------------------------------------------------------
...
} elseif {[regexp $PT_VER202009 $sh_product_version]} {
} else {
...
# CU check
SET_INIT_VAR ENABLE_CU_CHECK          false ;# true: Enable comparing cu value between report and expectation file
SET_INIT_VAR CUCHK_PLL_JITTER_MAX     0.300 ;# RV28F: 0.300ns
SET_INIT_VAR CUCHK_PLL_BASE_JITTER    0.100 ;# Base jitter value of PLL root oscillation
SET_INIT_VAR CUCHK_PLL_BASE_PERIOD    1.240 ;# Base period value of PLL root oscillation

# Physical Aware
SET_INIT_VAR PTECO_PHYSICAL_AWARE     false ;# true: Enable PA assumption command.
if {$PTECO_PHYSICAL_AWARE == "false"} {
    set PT_ECO_PA_FILE "NONE"
}
...
set_app_var timing_enable_max_capacitance_set_case_analysis true	;# (option) (EDA recommended true)
set_app_var timing_enable_max_transition_set_case_analysis false	;# (option) (EDA recommended false from PT2017.12)
set_app_var timing_point_arrival_attribute_compatibility true		;# (option) (EDA recommended true from PT2016.12-SP3-1)
set_app_var timing_enable_max_cap_precedence            false		;# (option) (EDA recommended false from PT2017.12)
set_app_var extract_model_short_syntax_compatibility    false		;# (option) (EDA recommended false from PT2016.12-SP3-1) 
set_app_var sh_global_per_message_limit                 0		;# (option) (EDA recommended 0 from PT2016.12-SP3)
set_app_var timing_report_union_tns                     true		;# (option) ;#default true (EDA recommended : true from PT2016.12-SP3-1)
...
set_app_var  eco_strict_pin_name_equivalence             true	;# keep pin nave equivalency for safe
...
if {$LOAD_MODEL=="SPEF" && $ENABLE_XT == "true"} {
    ...
    set_app_var si_xtalk_delay_analysis_mode              all_path_edges	;# [all_paths|all_path_edges] Before 'worst_path' (SoC)
    set_app_var si_ccs_small_bump_threshold_ratio         0.3
    set_app_var si_ccs_use_gate_level_simulation          true
    set_app_var si_xtalk_analysis_effort_level            medium
    set_app_var si_xtalk_double_switching_mode            clock_network	;# (must) (EDA recommended clock_network)
    set_app_var si_filter_accum_aggr_noise_peak_ratio     0.03	;# (option) (EDA recommended 0.03)
    set_app_var si_noise_update_status_level              high	;# (option) (EDA recommended high)
    set_app_var si_filter_per_aggr_to_average_xcap_ratio  0.0	;# Default ( For NLDM Library(Innored when CCS) )
    set_app_var si_filter_per_aggr_xcap                   0.0	;# Default ( For NLDM Library(Innored when CCS) )
    set_app_var si_filter_total_aggr_xcap_to_gcap_ratio   0.0	;# Default ( For NLDM Library(Innored when CCS) )
    set_app_var si_noise_effort_threshold_within_rails    0.2	;# Default
    set_app_var si_noise_composite_aggr_mode              statistical	;# (option) (EDA recommended statistical)
    set_app_var si_xtalk_composite_aggr_mode              statistical	;# (option) (EDA recommended statistical)
    set_app_var si_xtalk_composite_aggr_quantile_high_pct 99.73	;# (option) (EDA recommended 99.73)
    set_app_var si_noise_immunity_default_height_ratio    0.375	;# (option) (EDA recommended 0.375)
    set_app_var si_filter_per_aggr_noise_peak_ratio       0.01	;# (option) (EDA recommended 0.01)
    set_app_var si_xtalk_composite_aggr_noise_peak_ratio  0.01	;# (option) (EDA recommended 0.01)
    set_app_var si_analysis_logical_correlation_mode      true	;# Default
    set_app_var si_xtalk_exit_on_max_iteration_count      2	;# Default
...
puts "#   STA_MODE     : ${STA_MODE}"
if {[info exists DFT_MODE]} {
    puts "#   DFT_MODE     : ${DFT_MODE}"
}
puts "#   LibMode      : ${LIB_MODE}"
puts "#   LoadModel    : ${LOAD_MODEL}"
puts "#   ReportTiming : ${REPORT_OPT}"
puts "#   OPT_SS_KEY   : ${OPT_SS_KEY}"
puts "################################"
...
if {$ENABLE_RESTORE == "false"} {
    if {$USE_DB == "true"} {
        ...
        puts "* Information: Reading netlist ${NET_SRC}"
        read_verilog ${NET_SRC}
        if {[info exists READ_VERILOG]} {
            puts "* Information: Reading sub designs based on user definition."
            foreach tmp ${READ_VERILOG} {
                puts "* Information: Reading netlist $tmp"
                read_verilog $tmp
            }
        }
    }
...
#------------------------------------------------------------------
if {$STA_MODE == "mkHF"} {
    puts "* Information: Setting max_fanout ${MAXFANOUT_THRESHOLD}."
    set_max_fanout ${MAXFANOUT_THRESHOLD} [current_design]
    puts "* Information: Getting max_fanout report."
    redirect ${REPORT_DIR}/rep.${MODE}_max_fanout_${MAXFANOUT_THRESHOLD} {
        report_constraint -all_violators -max_fanout -nosplit
    }
    puts "* Information: making set_load command from max_fanout report."
    MK_HF_CMD $HF_FILE ${REPORT_DIR}/rep.${MODE}_max_fanout_${MAXFANOUT_THRESHOLD}
    ...
    if {$ENABLE_OCV=="true"} {
        ...
        if {[info exists special_ocv_param_table] && ![info exists special_ocv_param_table_clock_data]} {
            ...
            if {[info exists special_ocv_param_list(${CONDITION},${DELAY})]} {
                foreach ocv $special_ocv_param_list(${CONDITION},${DELAY}) {
                    set lib [lindex $ocv 0]
                    set_timing_derate -cell_delay -early [lindex $ocv 1] [eval "get_lib_cells ${lib}"]
                    set_timing_derate -cell_delay -late  [lindex $ocv 2] [eval "get_lib_cells ${lib}"]
                }
            }
...
if {$ENABLE_AOCVM == "true"} {
    if { [string match "MF3" $PROCESS] } {
        puts "* Information: PrimeTime load location from Spef for MF3 process AOCVM"
        set_app_var  read_parasitics_load_locations                 true ;# (must) EDA Recommendation: true     ;# ManatiiPF true
    } else {
        puts "* Information: PrimeTime doesn't load location from Spef for AOCVM"
        set_app_var  read_parasitics_load_locations                 false ;# (must) EDA Recommendation: true
    }
} elseif {$PTECO_PHYSICAL_AWARE == "true"} {
    puts "* Information: PrimeTime load location from Spef for Physical Aware future."
    set_app_var read_parasitics_load_locations true ;# (must) EDA Recommendation: true
}
...
if {$RESTORE == "true"} {
    ...
    switch ${LOAD_MODEL} {
        SPEF {
            ...
            set SPEF "${NET_SRC_DIR}/[expr $[concat LOAD_SPEF_${CONDITION}]]"
            puts "* Information: \$LOAD_MODEL has been set as SPEF."
            if {![file exists ${SPEF}]} {
                puts "* Error: Not found load-file ${SPEF}."
                exit
            }
            if {[info exists BLOCK_LOAD_${CONDITION}]} {
                puts "* Information: \$BLOCK_LOAD_${CONDITION} has been found. Hier-SPEF is applied."
                set BLOCK_SPEF [expr $[concat BLOCK_LOAD_${CONDITION}]]
                foreach MODULE_LOAD_PAIR ${BLOCK_SPEF} {
                    if {![llength ${MODULE_LOAD_PAIR}] == 2} {
                        puts "* Error: BLOCK_LOAD module name and load-file must be pair."
                        exit
                    } else {
                        set MODULE      [lindex ${MODULE_LOAD_PAIR} 0]
                        set MODULE_LOAD [lindex ${MODULE_LOAD_PAIR} 1]
                        set INSTANCE [get_cells -hierarchical * -filter "ref_name==$MODULE"]
                        if {[sizeof_collection ${INSTANCE}] == 0} {
                            puts "* Error: Instance of $MODULE was not found."
                            exit
                        } elseif {![file exist $MODULE_LOAD]} {
                            puts "* Error: Not found load-file $MODULE_LOAD."
                            exit
                        } else {
                            foreach_in_collection INST ${INSTANCE} {
                                set INST_NAME [get_attribute ${INST} full_name]
                                puts "* Information: Reading parasitics ${MODULE_LOAD} for ${MODULE} (instance ${INST_NAME})"
                                redirect -append #Info_Hier_Spef {
                                    puts "${MODULE} (instance ${INST_NAME}) $MODULE_LOAD"
                                }
                                if {$ENABLE_XT == "true"} {
                                    redirect ./LOG/read_spef_XT.${MODE}${SUFFIX} -tee {
                                        read_parasitics -keep_capacitive_coupling [subst ${MODULE_LOAD}] -path ${INST_NAME}
                                    }
                                } else {
                                    redirect ./LOG/read_spef.${MODE}${SUFFIX} -tee {
                ...
                if {$ENABLE_XT == "true"} {
                    redirect ./LOG/read_spef_XT.${MODE}${SUFFIX} -tee {
                        puts "* Information: No hier block spefs are set."
                    }
                } else {
                    redirect ./LOG/read_spef.${MODE}${SUFFIX} -tee {
                        puts "* Information: No hier block spefs are set."
            ...
            if {$ENABLE_XT == "true"} {
                set_app_var parasitics_log_file ./LOG/log.read_spef_XT.${MODE}${SUFFIX}
                puts "* Information: Reading parasitics ${SPEF} for ${TOP} with coupling cap."
                puts "LogFile : ${parasitics_log_file}"
                redirect -append ./LOG/read_spef_XT.${MODE}${SUFFIX} -tee { 
                    read_parasitics -keep_capacitive_coupling ${SPEF}
                }
            } else {
                set_app_var parasitics_log_file ./LOG/log.read_spef.${MODE}${SUFFIX}
                puts "* Information: Reading parasitics ${SPEF} for ${TOP} without coupling cap."
                puts "LogFile : ${parasitics_log_file}"
                redirect -append ./LOG/read_spef.${MODE}${SUFFIX} -tee {
...
###################################################################
# << Setting Physical information >>
###################################################################
if {$PTECO_PHYSICAL_AWARE == "true"} {
    puts "* Information: Preparing physical information start."
    set techLef $TECH_LEF
    set stdcellLef [globRecursive $Lib_DIR_STD "*.lef"]
    set HMLef      [globRecursive $Lib_DIR_HM  "*.lef"]
    set BlockLef   $BLOCK_LEF
    set inputLef [concat $stdcellLef $HMLef $BlockLef]
    set inputDef [concat $DEF $READ_DEF]
    set_eco_options \
        -physical_tech_lib_path $techLef \
        -physical_lib_path $inputLef \
        -physical_design_path $inputDef \
        -log_file LOG/read_physical_info.${MODE}${SUFFIX}.log
    redirect ${REPORT_DIR}/eco_options.${MODE}${SUFFIX}.rep {
        report_eco_options
    }
    check_resource Read_Physical_data_START
    check_eco
    check_resource Read_Physical_data_END 
}

# << Read PT ECO format command (doping & shotgunIPO & bypassHOLD) >>
if {$PT_ECO_FILE != "NONE"} {
...
# << Read PT ECO Physical Aware format command
if {$PTECO_PHYSICAL_AWARE && [info exists PT_ECO_PA_FILE] && $PT_ECO_PA_FILE != "NONE"} {
    puts "* Information: Applying Physical Aware ECO command."
    current_design ${TOP}

    set num 0
    foreach tmp ${PT_ECO_PA_FILE} {
        if {[file exists $tmp]} {
            puts "* $tmp is detected."
            read_eco_changes $tmp
            incr num
        } else {
            puts "* Error: '${tmp}' No such file or directory."
        }
    }
    if {$num == 0} { puts "* Information: No PT_ECO_PA_FILE has been applied." }
    current_design ${TOP}
}
...
if {$ENABLE_SS_SIMPLE == "true"} {
    if {[file exist "./LOAD/save.${LOAD_MODEL}.${CONDITION}${OPT_SS_KEY}${OPT_FLAG}"]} {
        puts "* Warning: Session has exist already './LOAD/save.${LOAD_MODEL}.${CONDITION}${OPT_SS_KEY}${OPT_FLAG}'."
    } else {
...
if {$CANCEL_CU == "true"} {
    ...
    if {$CANCEL_CLOCK == "true"} {
        ...
        if {$ENABLE_CU_CHECK == "true"} {
            puts "* Information: Comparing CU value start."
            check_resource CU_CHECK_START
            source ./scr/CHK_CU.tcl
            DIR_CHECK $REPORT_DIR/CU_CHECK
            CHK_CU LOG $REPORT_DIR/CU_CHECK ./apply/ALL/CU_${STA_MODE}_expect.list $CUCHK_PLL_JITTER_MAX $CUCHK_PLL_BASE_PERIOD $CUCHK_PLL_BASE_JITTER
            check_resource CU_CHECK_END
        } else {
            puts "* Information: Skip comparing CU value."
        }
    }
}
...
if {$CANCEL_UPDATE_TIMING == true} { 
    ...
    if {$LOAD_MODEL == "SPEF" && $ENABLE_ANNOTATED_CHECK == "true" && ![info exists MOD_NAME]} {
        ...
        puts "* Information: Annotated checking was skipped."
    }
...
if {$ENABLE_SMVA == "true"} {
    ...
    if {[regexp $PT_VER202009 $sh_product_version]} {
        set_app_var timing_cross_voltage_domain_analysis_mode legacy
    }
...
if {$ENABLE_AOCVM == "false" && $ENABLE_SMVA == "false" && $CANCEL_REPORT_TIMING == "false"} {
    ...
    if {$REPORT_LESSER_THAN_ONLY == "true"} {
        redirect ${REPORT_DIR}/timing_slack.${LOAD_MODEL}.${MODE}${NWORD}.rep {
...
if {$DELAY == "HOLD" && $ENABLE_AOCVM == "true" && $CANCEL_REPORT_TIMING == "false"} {
    puts "* Information: Getting HOLD AOCVM timing reports..."
    switch $AOCVM_MODE {
        PBA {
    ...
    puts "* Information: Getting HOLD AOCVM timing reports END."
}
...
if {$CANCEL_CONST_REPORT == "true"} {
    ...
    parallel_execute {
        {report_min_pulse_width -path_type summary -nosplit} ${REPORT_DIR}/const.min_pulse_${LOAD_MODEL}.${MODE}${NWORD}.endpsum
        {report_min_pulse_width -all_violators -nosplit -derate -sig 3 -input -path_type full_clock_expanded} ${REPORT_DIR}/const.min_pulse_${LOAD_MODEL}.${MODE}${NWORD}_${MIN_PULSE_THRESHOLD}.rep
        {report_min_pulse_width -all_violators -nosplit -derate -sig 3 -input} ${REPORT_DIR}/const.min_pulse_${LOAD_MODEL}.${MODE}${NWORD}_${MIN_PULSE_THRESHOLD}.summary
        {report_constraint -all_violators -min_period -verbose -nosplit} ${REPORT_DIR}/const.min_period_${LOAD_MODEL}.${MODE}${NWORD}.rep
        {report_constraint      -all_violators -nosplit -significant_digits 3 -path_type slack_only -verbose \
            -max_capacitance -min_capacitance -min_pulse_width -min_period} ${REPORT_DIR}/const.${LOAD_MODEL}.${MODE}${NWORD}.rep
        {report_constraint -all_violators -max_fanout -nosplit }    ${REPORT_DIR}/rep.${MODE}_max_fanout 
        {CALC_STD_AREA} ${REPORT_DIR}/rep.${MODE}_CALC_STD_AREA
    }
    # CHECK_VARIABLES 2017/02/20
...
if {$CANCEL_TRANnCAP_REPORT == "true"} {
    ...
    if {$SKIP_TRAN_LOWDRV == "false"} {
        #(4) set lowdrive output pin
        puts "* Information: Tran(4) set lowdrive output pin"
        if {[string match "RV40F" $PROCESS] } {
            puts "* Information: Lowdrive tran for RV40F"
            ...
            puts "* Information: Lowdrive tran for RV28F"
...
if {$ENABLE_REPORT_SUMMARY == "true" && $CANCEL_REPORT_TIMING == "false"} {
    puts "* Information: Making timing summary for DELAY:$DELAY..."
    if {$DELAY == "HOLD"} {
...
if {$ENABLE_REPORT_NOCLK == "true"} {
    ...
    redirect ${REP_CT_NOCLK}.no_clock_pins.tmp {
        CHK_NO_CLOCK ${REP_CT_NOCLK}
        CHK_COVERAGE ${REP_RC_UNTST}
    }
    sh sort -u ${REP_CT_NOCLK}.no_clock_pins.tmp > ${REP_CT_NOCLK}.no_clock_pins
    sh rm ${REP_CT_NOCLK}.no_clock_pins.tmp

    if {![file exists $FILE_CLKVT_CFG]} {
        puts "* Error: $FILE_CLKVT_CFG is not found..."
    } else {
...
if { $ENABLE_BIGSKEW == "true" } {
    source ./scr/GET_BIG_SKEW_REPORT.tcl
