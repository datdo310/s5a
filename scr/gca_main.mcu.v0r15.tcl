...
#            v0r14 2019/01/11   Y.Oda           add ENABLE_AOCVM variable for CU constraints
...
SET_INIT_VAR CANCEL_TENTATIVE         false ;# true: Cancel reading TENTAITVE consttaint
...
switch -regexp -- ${STA_MODE} {
        ...
        ^(DFT) {
                ...
                #set FILE_DFT_MPI            ${APPLY_DIR}/DFT/Common/${DFT_MODE}_MPI_false_setting.ptsc
...
if {$ENABLE_ERROR_FILE == "true"} {
        ...
        ERROR_FILE IO_LOAD_CONST_FILE
        ERROR_FILE IO_DRV_CONST_FILE
        ## timing constraints
