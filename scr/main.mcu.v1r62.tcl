...
#          : mcu.v1r59 2021/08/16 Add ENABLE_CU_CHECK
#          : mcu.v1r60 2021/11/29 Optimize mkHF/ML netlist section
#          : mcu.v1r61 2021/12/13 Add PT_VER202009
#          : mcu.v1r62 2022/01/12 Delete mkSDF mode, Add message information of input netlist/spef
...
if {$PTECO_PHYSICAL_AWARE == "true"} {
    ...
    set inputLef [concat $MACRO_LEF $BLOCK_LEF]
...
if {$PTECO_PHYSICAL_AWARE && $PT_ECO_PA_FILE != "NONE"} {
