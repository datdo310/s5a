...
proc get_clock_list_from_arrival_window {
    ...
    if { $direction == "in" } {
        ...
        set arrival_window [get_attribute -quiet \
                        [get_pins -quiet -leaf -of [get_nets -quiet -of $pin] \
...
proc reduce_clock_margin {
    ...
    foreach_in_collection clk [get_clocks -quiet *] {
        ...
        if { $period == "" } {
            set DLCLT_ReducedPeriod($clkname) 100000
        } else {
...
proc judge_half_cycle {
    ...
    if { [string equal $enable_different_clock "yes"] } {
        ...
        if { $from_clock == "" || $to_clock == "" } {
            ...
            if { $from_period == "" } { set from_period 100000 }
            set to_period [get_attribute -q $to_clock period]
            if { $to_period == "" } { set to_period 100000 }
            if { $from_period > $to_period } {
                set ratio [get_clock_ratio $to_period $from_period]
                if { [expr $ratio % 2] > 0 } {
                    return [judge_half_cycle_same_clk $start_edge $end_edge]
...
##----------------------------------------------------------
### TLH
proc check_drive_limit_TLH { drive } {
    if { $drive <= 5 } {
        return 1
    }
    return 0
...
### THH
proc check_drive_limit_THH { drive } {
    if { $drive <= 30 } {
        return 1
    }
    return 0
...
### TMH
proc check_drive_limit_TMH { drive } {
    if { $drive <= 8 } {
        return 1
    }
    return 0
...
##----------------------------------------------------------
############################################################
# PROCEDURE       : set_maxtran_lowdrv_Vall_F3p200000et08to4p800000et08
# TYPE            : lowdrv
# VOLTAGE RANGE   : 0.0[V] - inf[V]
# FREQUENCY RANGE : 320e6[Hz] - 480e6[Hz]
# MARGIN          : 1.0
#---------------------------------------
# VT        Drive     Constraint
#---------------------------------------
...
# TLH       0.5       0.65      
############################################################
## set_maxtran_lowdrv_Vall_F3p200000et08to4p800000et08 for THH cells
set MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_THH_X8 [expr $Tfactor*0.25*$DLCLT_MAXTRAN_LOWDRV_MARGIN]
set MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_THH_X15 [expr $Tfactor*0.30*$DLCLT_MAXTRAN_LOWDRV_MARGIN]
set MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_THH_X30 [expr $Tfactor*0.50*$DLCLT_MAXTRAN_LOWDRV_MARGIN]
proc set_maxtran_lowdrv_Vall_F3p200000et08to4p800000et08_THH { pin drive overwrite } {
    global DLCLT_SET_MAXTRAN_LOWDRV_FLAG
    if { $drive <= 8 } {
        if { $overwrite == 1 } {
            set_max_transition $::MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_THH_X8 $pin
            ...
            if { $::MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_THH_X8 < $old_const } {
                set_max_transition $::MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_THH_X8 $pin
                set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
            }
        }
        ...
        if { $overwrite == 1 } {
            set_max_transition $::MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_THH_X15 $pin
            set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
        } else {
            set old_const [get_attribute -quiet $pin max_transition]
            if { $old_const == "" } {
            ...
            if { $::MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_THH_X15 < $old_const } {
                set_max_transition $::MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_THH_X15 $pin
                set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
            }
        }
        ...
        if { $overwrite == 1 } {
            set_max_transition $::MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_THH_X30 $pin
            set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
        } else {
            set old_const [get_attribute -quiet $pin max_transition]
            if { $old_const == "" } {
            ...
            if { $::MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_THH_X30 < $old_const } {
                set_max_transition $::MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_THH_X30 $pin
                set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
            }
        }
...
## set_maxtran_lowdrv_Vall_F3p200000et08to4p800000et08 for TMH cells
set MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_TMH_X8 [expr $Tfactor*0.60*$DLCLT_MAXTRAN_LOWDRV_MARGIN]
proc set_maxtran_lowdrv_Vall_F3p200000et08to4p800000et08_TMH { pin drive overwrite } {
    global DLCLT_SET_MAXTRAN_LOWDRV_FLAG
    if { $drive <= 8 } {
        if { $overwrite == 1 } {
            set_max_transition $::MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_TMH_X8 $pin
            set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
        } else {
            set old_const [get_attribute -quiet $pin max_transition]
            if { $old_const == "" } {
            ...
            if { $::MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_TMH_X8 < $old_const } {
                set_max_transition $::MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_TMH_X8 $pin
                set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
            }
        }
...
## set_maxtran_lowdrv_Vall_F3p200000et08to4p800000et08 for TLH cells
set MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_TLH_X5 [expr $Tfactor*0.65*$DLCLT_MAXTRAN_LOWDRV_MARGIN]
proc set_maxtran_lowdrv_Vall_F3p200000et08to4p800000et08_TLH { pin drive overwrite } {
    global DLCLT_SET_MAXTRAN_LOWDRV_FLAG
    if { $drive <= 5 } {
        if { $overwrite == 1 } {
            set_max_transition $::MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_TLH_X5 $pin
            set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
        } else {
            set old_const [get_attribute -quiet $pin max_transition]
            if { $old_const == "" } {
            ...
            if { $::MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_TLH_X5 < $old_const } {
                set_max_transition $::MAXTRAN_LOWDRV_Vall_F3p200000et08to4p800000et08_TLH_X5 $pin
                set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
            }
        }
...
############################################################
# PROCEDURE       : set_maxtran_lowdrv_Vall_F1p600000et08to3p200000et08
# TYPE            : lowdrv
# VOLTAGE RANGE   : 0.0[V] - inf[V]
# FREQUENCY RANGE : 160e6[Hz] - 320e6[Hz]
# MARGIN          : 1.0
#---------------------------------------
# VT        Drive     Constraint
#---------------------------------------
...
# TLH       0.5       0.65      
############################################################
## set_maxtran_lowdrv_Vall_F1p600000et08to3p200000et08 for THH cells
set MAXTRAN_LOWDRV_Vall_F1p600000et08to3p200000et08_THH_X8 [expr $Tfactor*0.35*$DLCLT_MAXTRAN_LOWDRV_MARGIN]
set MAXTRAN_LOWDRV_Vall_F1p600000et08to3p200000et08_THH_X20 [expr $Tfactor*0.5*$DLCLT_MAXTRAN_LOWDRV_MARGIN]
proc set_maxtran_lowdrv_Vall_F1p600000et08to3p200000et08_THH { pin drive overwrite } {
    global DLCLT_SET_MAXTRAN_LOWDRV_FLAG
    if { $drive <= 8 } {
        if { $overwrite == 1 } {
            set_max_transition $::MAXTRAN_LOWDRV_Vall_F1p600000et08to3p200000et08_THH_X8 $pin
            set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
        } else {
            set old_const [get_attribute -quiet $pin max_transition]
            if { $old_const == "" } {
            ...
            if { $::MAXTRAN_LOWDRV_Vall_F1p600000et08to3p200000et08_THH_X8 < $old_const } {
                set_max_transition $::MAXTRAN_LOWDRV_Vall_F1p600000et08to3p200000et08_THH_X8 $pin
                set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
            }
        }
        ...
        if { $overwrite == 1 } {
            set_max_transition $::MAXTRAN_LOWDRV_Vall_F1p600000et08to3p200000et08_THH_X20 $pin
            set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
        } else {
            set old_const [get_attribute -quiet $pin max_transition]
            if { $old_const == "" } {
            ...
            if { $::MAXTRAN_LOWDRV_Vall_F1p600000et08to3p200000et08_THH_X20 < $old_const } {
                set_max_transition $::MAXTRAN_LOWDRV_Vall_F1p600000et08to3p200000et08_THH_X20 $pin
                set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
            }
        }
...
## set_maxtran_lowdrv_Vall_F1p600000et08to3p200000et08 for TMH cells
set MAXTRAN_LOWDRV_Vall_F1p600000et08to3p200000et08_TMH_X8 [expr $Tfactor*0.6*$DLCLT_MAXTRAN_LOWDRV_MARGIN]
proc set_maxtran_lowdrv_Vall_F1p600000et08to3p200000et08_TMH { pin drive overwrite } {
    global DLCLT_SET_MAXTRAN_LOWDRV_FLAG
    if { $drive <= 8 } {
        if { $overwrite == 1 } {
            set_max_transition $::MAXTRAN_LOWDRV_Vall_F1p600000et08to3p200000et08_TMH_X8 $pin
            set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
        } else {
            set old_const [get_attribute -quiet $pin max_transition]
            if { $old_const == "" } {
            ...
            if { $::MAXTRAN_LOWDRV_Vall_F1p600000et08to3p200000et08_TMH_X8 < $old_const } {
                set_max_transition $::MAXTRAN_LOWDRV_Vall_F1p600000et08to3p200000et08_TMH_X8 $pin
                set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
            }
        }
...
## set_maxtran_lowdrv_Vall_F1p600000et08to3p200000et08 for TLH cells
set MAXTRAN_LOWDRV_Vall_F1p600000et08to3p200000et08_TLH_X5 [expr $Tfactor*0.65*$DLCLT_MAXTRAN_LOWDRV_MARGIN]
proc set_maxtran_lowdrv_Vall_F1p600000et08to3p200000et08_TLH { pin drive overwrite } {
    global DLCLT_SET_MAXTRAN_LOWDRV_FLAG
    if { $drive <= 5 } {
        if { $overwrite == 1 } {
            set_max_transition $::MAXTRAN_LOWDRV_Vall_F1p600000et08to3p200000et08_TLH_X5 $pin
            set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
        } else {
            set old_const [get_attribute -quiet $pin max_transition]
            if { $old_const == "" } {
            ...
            if { $::MAXTRAN_LOWDRV_Vall_F1p600000et08to3p200000et08_TLH_X5 < $old_const } {
                set_max_transition $::MAXTRAN_LOWDRV_Vall_F1p600000et08to3p200000et08_TLH_X5 $pin
                set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
            }
        }
...
############################################################
# PROCEDURE       : set_maxtran_lowdrv_Vall_Fto1p600000et08
# TYPE            : lowdrv
# VOLTAGE RANGE   : 0.0[V] - inf[V]
# FREQUENCY RANGE : 0.0[Hz] - 160e6[Hz]
# MARGIN          : 1.0
#---------------------------------------
# VT        Drive     Constraint
#---------------------------------------
...
# TMH       0.5       1.1       
############################################################
## set_maxtran_lowdrv_Vall_Fto1p600000et08 for THH cells
set MAXTRAN_LOWDRV_Vall_Fto1p600000et08_THH_X8 [expr $Tfactor*0.7*$DLCLT_MAXTRAN_LOWDRV_MARGIN]
set MAXTRAN_LOWDRV_Vall_Fto1p600000et08_THH_X10 [expr $Tfactor*1.0*$DLCLT_MAXTRAN_LOWDRV_MARGIN]
proc set_maxtran_lowdrv_Vall_Fto1p600000et08_THH { pin drive overwrite } {
    global DLCLT_SET_MAXTRAN_LOWDRV_FLAG
    if { $drive <= 8 } {
        if { $overwrite == 1 } {
            set_max_transition $::MAXTRAN_LOWDRV_Vall_Fto1p600000et08_THH_X8 $pin
            set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
        } else {
            set old_const [get_attribute -quiet $pin max_transition]
            if { $old_const == "" } {
            ...
            if { $::MAXTRAN_LOWDRV_Vall_Fto1p600000et08_THH_X8 < $old_const } {
                set_max_transition $::MAXTRAN_LOWDRV_Vall_Fto1p600000et08_THH_X8 $pin
                set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
            }
        }
        ...
        if { $overwrite == 1 } {
            set_max_transition $::MAXTRAN_LOWDRV_Vall_Fto1p600000et08_THH_X10 $pin
            set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
        } else {
            set old_const [get_attribute -quiet $pin max_transition]
            if { $old_const == "" } {
            ...
            if { $::MAXTRAN_LOWDRV_Vall_Fto1p600000et08_THH_X10 < $old_const } {
                set_max_transition $::MAXTRAN_LOWDRV_Vall_Fto1p600000et08_THH_X10 $pin
                set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
            }
        }
...
## set_maxtran_lowdrv_Vall_Fto1p600000et08 for TMH cells
set MAXTRAN_LOWDRV_Vall_Fto1p600000et08_TMH_X5 [expr $Tfactor*1.1*$DLCLT_MAXTRAN_LOWDRV_MARGIN]
proc set_maxtran_lowdrv_Vall_Fto1p600000et08_TMH { pin drive overwrite } {
    global DLCLT_SET_MAXTRAN_LOWDRV_FLAG
    if { $drive <= 5 } {
        if { $overwrite == 1 } {
            set_max_transition $::MAXTRAN_LOWDRV_Vall_Fto1p600000et08_TMH_X5 $pin
            set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
        } else {
            set old_const [get_attribute -quiet $pin max_transition]
            if { $old_const == "" } {
            ...
            if { $::MAXTRAN_LOWDRV_Vall_Fto1p600000et08_TMH_X5 < $old_const } {
                set_max_transition $::MAXTRAN_LOWDRV_Vall_Fto1p600000et08_TMH_X5 $pin
                set DLCLT_SET_MAXTRAN_LOWDRV_FLAG 1
            }
        }
