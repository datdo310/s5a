...
if {[regexp $GCA_VER201212 $sh_product_version]} {
	...
	# For PT2017.12 SP3-2
	# source /common/appl/Synopsys/primetime/2017.12-sp3-2/9001516371_WA.tbc  ;# W/A for MaxTran with jump clock
...
SET_INIT_VAR PTC_WAIVER_RULE_DIR                   ./apply/PTC_WAIVER_RULES ;# PTC waiver Custom rules record directory from PTC2019
...
# << checkGCA result.>>
if {[regexp $GCA_VER201903 $sh_product_version]} {
	source scr/chkGCAresult_PTC2019.tcl
} else {
