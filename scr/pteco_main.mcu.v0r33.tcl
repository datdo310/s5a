    ...
    if {$RESTORE == "true"} {
        create_scenario \
            ...
            -specific_variables { \
                ...
                PTECO_SIZE_LIMIT_RATIO \
                FILE_DONT_USE FILE_DONT_TOUCH FILE_DONT_TOUCH_HM FILE_SIZE_GROUP FILE_POWER_ATTR FILE_RMBUF_DONT_TOUCH \
...
if {$PTECO_FIX_DRC == "true"} {
    ...
    if {$PTECO_FIX_DRC_VTH_ONLY == "true"} {
...
if { $PTECO_FIX_SETUP == "true" } {
    ...
    if {$PTECO_FIX_SETUP_SIZE_ONLY == "true"} {
        ...
        if {$PTECO_FIX_SETUP_SEQ == "true"} {
            ...
            puts "* Information: PTECO SETUP for Sequential-cell is End."
        }
    }
    if {$PTECO_FIX_SETUP_VTH_ONLY == "true"} {
    ...
    if {$PTECO_FIX_SETUP_SIZE_ONLY == "false" && $PTECO_FIX_SETUP_VTH_ONLY == "false"} {
