...
# v0r2: 2020/10/16 Y.Oda Support for MF3
##########################################################
if {![info exists PROCESS]} {
	...
	puts "*Information: add_maxcap_of_hv.tcl select MF3 MaxCap for HV"
} else {
...
if {[string match "RV40F" $PROCESS] } {
	...
	puts "Information: add_maxcap_of_hv.tcl has not applied HV MaxCap because it's same to core MaxCap(clock:0.4, data:0.8)"
}
