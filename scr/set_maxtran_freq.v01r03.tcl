...
#------------------------------------------------------------
# Stable Core Voltage
#   MaxTran(clock_path) = 0.0*T + 1.25[ns]
#   MaxTran(data_path)  = 0.0*T + 2.5 [ns]

    puts "Information: set_maxtran_per_freq_CORE_MF3"

    set clock_const 1.25
    set data_const  2.5  
    set_max_transition $clock_const [all_clocks] -clock_path -rise -fall
    set_max_transition $data_const  [all_clocks] -data_path  -rise -fall
}
