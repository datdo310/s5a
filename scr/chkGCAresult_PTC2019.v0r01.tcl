#################################################################
#  chkGCAresult_PTC2019.tcl
# Ver   : Date       : Auther        : Description
# v0r00 :            : REL/Y.Oda     : first release
# v0r01 : 2020/12/11 : REL/A.Yoshida : support 7T cells
#
################################################################
##------------------------------------------------------
## Confirm NoCLOCK Sequential cells by case/tie setting
##------------------------------------------------------
## support 7T cells on 2020/12/11 by REL/A.Yoshida
...
proc chkGCAresult { {INFILE} } {
    ...
    foreach SCR {"DES_0001" "DES_0002" "DES_0003"} {
        if {[file exists ${OUT_DIR}/${GCA_MODE}_${SCR}.txt]} {
            sh rm ${OUT_DIR}/${GCA_MODE}_${SCR}.txt
        }
    }
